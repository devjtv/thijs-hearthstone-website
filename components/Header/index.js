            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex h-full gap-6 justify-start items-center">
                    ...
                    <nav className="flex gap-4 items-center">
                        ...
                        <a href="/about" className="text-3xl hover:text-highlight transition-all duration-300">
                            About
                        </a>
                        <a href="/contact" className="text-3xl hover:text-highlight transition-all duration-300">
                            Contact
                        </a>
                    </nav>
                </div>
